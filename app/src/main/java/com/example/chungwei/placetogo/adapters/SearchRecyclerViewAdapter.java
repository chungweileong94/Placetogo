...
public class SearchRecyclerViewAdapter extends RecyclerView.Adapter<SearchRecyclerViewAdapter.ViewHolder> {
    ...
    public SearchRecyclerViewAdapter(Context context, ArrayList<Item> list, FoursquareService foursquareService) {
    ...
    public SearchRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SearchRecyclerViewAdapter.ViewHolder(LayoutInflater.from(context)
                .inflate(R.layout.location_item_layout_search, parent, false));
    }
...
//                    v.getContext().startActivity(i);
        ...
        void bind(@NonNull Item item) {
            ...
            address_textView.setText(item.getVenue().getLocation() == null ||
                    item.getVenue().getLocation() == null ||
                    item.getVenue().getLocation().getFormattedAddress().size() == 0 ?
                    "-" : joinStrings(item.getVenue().getLocation().getFormattedAddress()));
